        ...
        <?php if ( isset( $search_entries ) && is_array( $search_entries ) && $search_entries ) { ?>
                <?php foreach ( $search_entries as $entry ){
                    ...
                    <tr class="search-table-data">
                        ...
                        <td>
                            <a href="#" data-entry='<?php echo htmlentities( wp_json_encode( $entry ?: new stdClass() ), ENT_QUOTES, 'UTF-8' ); ?>' class="button edit-setting"><?php echo esc_html__( 'Edit', 'smart-search-control' ); ?></a>
